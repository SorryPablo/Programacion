...
\usepackage{parskip}
\usepackage[style = apa, backend = biber,citestyle=numeric, sorting = nty]{biblatex}
...
\section{Práctica I (Corriente Continua) \cite{apuntesProfesor}}
...
\section{Práctica II (Corriente Alterna) \cite{apuntesProfesor2}}
...
\subsection{Código y archivos \cite{codigo}}
...
\newpage
\printbibliography[title={Bibliografía\protect\footnotemark[5]},heading=bibnumbered]
\footnotetext[5]{Única porque se han usado los mismos recursos en ambas prácticas}
