...
\ref{eq:imped}\footnote{Tomaremos para el resto de la práctica $s(R)=0$ y $s(C)=0$ porque son valores que suponemos ciertos desde el apartado de Material},
...
\begin{enumerate}
\item Representación de tablas (Tab. \ref{tab:tiempos}):
\bigskip
\begin{minted}{python}
    import pandas as pd
    import numpy as np
