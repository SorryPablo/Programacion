...
#17
ti_table<-table(titanic$embarked)
which(ti_table==max(ti_table))

#18
ti_pclass_sexo<-table(titanic$pclass,titanic$sex);ti_pclass_sexo

#19
barplot(ti_pclass_sexo,legend=c("1","2","3"),beside=T)
